...
TFile *f1 = TFile::Open("fakebkg_etau_2017.root");
f1->GetObject("h1",h[0]);

TFile *fstat = TFile::Open("fakebkg_etau_2017.root");
fstat->GetObject("h1",hstat);

TFile *f2 = TFile::Open("ttbar_etau_2017.root");
f2->GetObject("h1",h[1]);

TFile *f3 = TFile::Open("prompt_etau_2017.root");
...
c1->Modified();
        ...
        double y_legend = hs->GetMaximum() + 230;
        double x_legend = 170;
...
c1->SaveAs("bkg_etau_2017.root");
c1->SaveAs("bkg_etau_2017.pdf");
	}
