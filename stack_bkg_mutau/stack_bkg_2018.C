...
TFile *f1 = TFile::Open("fakebkg_mutau_2018.root");
f1->GetObject("h1",h[0]);

TFile *fstat = TFile::Open("fakebkg_mutau_2018.root");
fstat->GetObject("h1",hstat);

TFile *f2 = TFile::Open("ttbar_mutau_2018.root");
f2->GetObject("h1",h[1]);

TFile *f3 = TFile::Open("prompt_mutau_2018.root");
...
c1->Modified();
        ...
        double y_legend = hs->GetMaximum() + 1200;
        double x_legend = 170;
