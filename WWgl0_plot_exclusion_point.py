...
mpkv0p25 = [0.1, 10, 20, 40, 80, 120, 160, 200, 240, 279.1, 323.8 ]
mpkv0p50 =  [100, 130, 160, 180, 210, 250, 279.1, 410.2, 466.8, 541.3, 624.7 ] 
mpkv0p75 = [110, 150, 180, 220, 260, 308.9, 436.9, 615.6, 722.8, 818.0, 877.6]
mp = [100, 150, 200, 230,264.2, 398.4, 544.6, 771.2, 890.5, 962.1, 1030.7]  #mutau gl=0
...
mpkv0p50_obs = [110, 130, 150, 170, 190, 220, 250, 314.9, 383.4, 431.1, 466.8]
mpkv0p75_obs = [100, 130, 160, 200, 250, 297, 365.5, 454.8, 874.6, 966.9, 1050.3 ]
mp_obs = [100, 150, 170, 190, 210, 294.0, 407.4, 902.4, 1036.6, 1173.8, 1266.3  ]
...
mp0p25_error1 = [10, 20, 40, 80, 120, 160, 200, 250, 297.0, 347.7, 380.5] #-1 sigma 
mp0p25_error2 = [0.1, 0.5, 10, 20, 40, 80, 120, 160, 190, 220, 260]    #+1 sigma

mp0p5_error1 = [130, 160, 170, 210, 250, 279, 350.6, 463.8, 562.1, 666.4, 720.0] #-1 sigma 
mp0p5_error2 = [80, 100, 130, 160, 170, 210, 250, 353.6, 425.1, 466.8, 499.6]    #+1 sigma

mp0p75_error1 = [150, 180, 220, 260, 308, 374.4, 487.6, 704.9, 835.9, 919.3, 984.8] #-1 sigma 
mp0p75_error2 = [80, 110, 150, 180, 220, 260, 380.4, 493.5, 630.5, 704.9, 764.4]    #+1 sigma

mp_error1 = [150, 200, 240, 297.0, 341.7, 461.0, 678.7, 881.6, 988.9, 1090.3, 1182.8 ] #-1 sigma
mp_error2 = [80, 100, 160, 200, 220, 341.7, 461.0, 672.8, 789.1, 872.6, 932.3] #+1 sigma
...
#    grkv0p1_error.Draw("Fsame")
    ...
    leg_obs.SetHeader("#splitline{VBF Z' #rightarrow WW (g_{l} = 0, g_{h} = 1)}{Observed}")
...
#    gBenchmark.Show( 'hsimple' )
    ...
    c1.Modified()
    c1.Update()
    c1.SaveAs("br_2D_WW_gl0_UpperLimit.pdf")
    c1.SaveAs("br_2D_WW_gl0_UpperLimit.png")
    c1.SaveAs("br_2D_WW_gl0_UpperLimit.root")
    c1.Close()
