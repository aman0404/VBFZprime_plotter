...
TFile *f1 = TFile::Open("2017bkg/DY+Jets_emu_2016.root");
f1->GetObject("h1",h[0]);

TFile *fstat = TFile::Open("2017bkg/DY+Jets_emu_2016.root");
fstat->GetObject("h1",hstat);

TFile *f2 = TFile::Open("2017bkg/W+Jets_emu_2016.root");
f2->GetObject("h1",h[1]);

TFile *f3 = TFile::Open("2017bkg/ttbar_emu_new_2017_emu_2016.root");
//TFile *f3 = TFile::Open("2017bkg/tbart_emu_2016.root");
f3->GetObject("h1",h[2]);


TFile *f4 = TFile::Open("2017bkg/SingleTop_emu_2016.root");
f4->GetObject("h1",h[3]);

TFile *f5 = TFile::Open("2017bkg/VV_emu_2016.root");
f5->GetObject("h1",h[4]);


TFile *f41 = TFile::Open("VBF_Zprime_tau_tau_M_1000_gl_0_gh_1_kv_1p0.root");
f41->GetObject("NRecoBJet/Muon1Electron1ReconstructableMass",hsignal[0]);

TFile *f51 = TFile::Open("VBF_Zprime_tau_tau_M_1500_gl_0_gh_1_kv_1p0.root");
f51->GetObject("NRecoBJet/Muon1Electron1ReconstructableMass",hsignal[1]);

TFile *f61 = TFile::Open("VBF_Zprime_WW_M_750_gl_0_gh_1_kv_1p0.root");
f61->GetObject("NRecoBJet/Muon1Electron1ReconstructableMass",hsignal[2]);
...
TH1F *hsig1 = (TH1F*)hsignal[0]->Rebin(18,"hsig1",bins);
TH1F *hsig2 = (TH1F*)hsignal[1]->Rebin(18,"hsig2",bins);
TH1F *hsig3 = (TH1F*)hsignal[2]->Rebin(18,"hsig3",bins);
TH1F *hsig4 = (TH1F*)hsignal[3]->Rebin(18,"hsig4",bins);
...
hs->GetXaxis()->SetTitle("M_{e#mu,MET} [GeV]");
hs->GetXaxis()->SetTitleOffset(1.1);
c1->Update();
c1->Modified();

        double y_legend = hs->GetMaximum() + 190;
        double x_legend = 170;
...
TLegend *legend=new TLegend(0.52,0.59,0.89,0.88);
	//legend->SetHeader("NRecoJet1");
        legend->SetTextSize(0.03);
        legend->AddEntry(h[2],"t#bar{t}","f");
...
c1->SaveAs("bkg_emu_2017.root");
c1->SaveAs("bkg_emu_2017.pdf");
	}
